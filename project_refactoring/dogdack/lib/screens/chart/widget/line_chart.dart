...
class LineChart extends CustomPainter {
  ...
  LineChart({
    ...
    required this.pointSize, required this.lineWidth, required this.lineColor, required this.pointColor, required this.minValueIndex, required this.maxValueIndex});
